...
echo '<div class="card mt-3 mb-2">
        <div class="card-body mx-4 row align-content-center mb-4">
            <div class="card-text mt-3 col">
                ...
                <a href="../client-admin/detail.php?id='.$row['id_pembayaran'].'" class="btn btn-primary" target="_blank">Detail</a>
                <a href="../client-admin/invoice.php?id='.$row['id_pembayaran'].'" class="btn btn-info text-light">Cetak</a>
            </div>

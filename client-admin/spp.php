    ...
    <body>
            ...
            <div class="container-fluid">
                <div class="container">
                        <h1>Data SPP</h1>
                    <?php
                    include '../server/api-spp/getData.php';
                    ?>    
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body m-3">
                                        <form action="../server/api-spp/postData.php" method="post">
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="row">
                                            <div class="col h6">Tahun</div>
                                            <input type="number" name="tahun" class="form-control col-md-8">
                                        </div>
                                    </div>
                                    <div class="form-group mb-2">
                                        <div class="row">
                                            <div class="col h6">Nominal</div>
                                            <input type="number" name="nominal" class="form-control col-md-8">
                                        </div>
                                    </div>
